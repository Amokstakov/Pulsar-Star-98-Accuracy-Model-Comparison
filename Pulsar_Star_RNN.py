...
parameters = {'penalty':('l1','l2'),'solver':('newton-cg','lbfgs','sag','saga'),'max_iter':[100,250,500,750]}
...
svm = svm.SVC()
parameters = {'kernel':('linear','poly','rbf','sigmoid'),'degree':[1,3,5,7],'gamma':('scale','auto')}
...
model = svm(gamma='scale', degree=1, kernel='linear', C=1) # sitting model parameters
